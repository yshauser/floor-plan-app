 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ms=(i,e)=>{const n=oe.forwardRef(({className:s,...o},u)=>oe.createElement(Lw,{ref:u,iconNode:e,className:ZE(`lucide-${Pw(r_(i))}`,`lucide-${i}`,s),...o}));return n.displayName=r_(i),n};/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qC(i){Oi(new oi("platform-logger",e=>new eC(e),"PRIVATE")),Oi(new oi("heartbeat",e=>new UC(e),"PRIVATE")),Zn(ym,__,i),Zn(ym,__,"esm2020"),Zn("fire-js","")}qC("");var w_=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Js=new Qm("@firebase/firestore");function Ja(){return Js.logLevel}function de(i,...e){if(Js.logLevel<=ze.DEBUG){const n=e.map(Wm);Js.debug(`Firestore (${bo}): ${i}`,...n)}}function dr(i,...e){if(Js.logLevel<=ze.ERROR){const n=e.map(Wm);Js.error(`Firestore (${bo}): ${i}`,...n)}}function ho(i,...e){if(Js.logLevel<=ze.WARN){const n=e.map(Wm);Js.warn(`Firestore (${bo}): ${i}`,...n)}}function Wm(i){if(typeof i=="string")return i;try{/**
* @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class W0{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}W0.type="NONE";const CE=W0;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function jI(i,e,n=!1){const{auth:s}=i;if(si(s.app))return Promise.reject(as(s));const o="reauthenticate";try{const u=await Zl(i,fS(s,o,e,i),n);_e(u.idToken,s,"internal-error");const f=bp(u.idToken);_e(f,s,"internal-error");const{sub:m}=f;return _e(i.uid===m,s,"user-mismatch"),_o._forOperation(i,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&li(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qS="installations",BO="installations-internal",qO=i=>{const e=i.getProvider("app").getImmediate(),n=jO(e),s=To(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:s,_delete:()=>Promise.resolve()}},HO=i=>{const e=i.getProvider("app").getImmediate(),n=To(e,qS).getImmediate();return{getId:()=>LO(n),getToken:o=>UO(n,o)}};function FO(){Oi(new oi(qS,qO,"PUBLIC")),Oi(new oi(BO,HO,"PRIVATE"))}FO();Zn(AS,Np);Zn(AS,Np,"esm2020");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
